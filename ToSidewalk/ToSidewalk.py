...
def create_crosswalk_nodes(sidewalks, sidewalk_nodes, intersection_node, adj_street_nodes):
    ...
    return sidewalks, sidewalk_nodes, new_crosswalk_node_ids, source_table
...
def connect_crosswalk_nodes(intersection_node, sidewalks, sidewalk_nodes, source_table):
...
def make_crosswalks(street_nodes, sidewalk_nodes, streets, sidewalks):
    ...
    for intersection_node in intersection_nodes:
        ...
        sidewalks, sidewalk_nodes, new_crosswalk_node_ids, source_table = create_crosswalk_nodes(sidewalks, sidewalk_nodes, intersection_node, adj_street_nodes)

        # Connect the crosswalk nodes with correct sidewalk nodes
        sidewalk_nodes, sidewalks = connect_crosswalk_nodes(intersection_node, sidewalks, sidewalk_nodes, source_table)
    return sidewalk_nodes, sidewalks
